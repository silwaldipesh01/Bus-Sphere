...
namespace Bus_Sphere.CustomControls
{
    public class CustomDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Image.FromStream(new System.IO.MemoryStream(Properties.Resources.calendarWhite));
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Image.FromStream(new System.IO.MemoryStream(Properties.Resources.calendarDark));
                else calendarIcon = Image.FromStream(new System.IO.MemoryStream(Properties.Resources.calendarWhite));
                this.Invalidate();
            }
        }
